...
"""Landing chrome. The landing page is this product's own backlog rendered
by the same board engine as every tenant board (web.board.render_board);
...
<ul>
  ...
  <li>Below is this product's own backlog, rendered by the same engine that will serve yours.</li>
