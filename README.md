...
`/` serves the pitch plus this product's own backlog (`docs/product/backlog.md`) rendered by the one board engine every tenant will use. Architecture: `docs/architecture.md`.
